...
export const AnimationComponent = () => {
  ...
  const stampScale = interpolate(frame, [20, 40], [1.3, 1], { extrapolateLeft: 'clamp', extrapolateRight: 'clamp' });
  const stampRotate = interpolate(frame, [20, 40], [8, 0], { extrapolateLeft: 'clamp', extrapolateRight: 'clamp' });
  ...
  return (
    <div style={{ position: 'absolute', top: 0, left: 0, width: 1920, height: 1080, overflow: 'hidden', backgroundColor: 'BACKGROUND_COLOR' }}>
      <div style={{ position: 'absolute', top: 108, left: 192, width: 1536, height: 864, border: '1px solid rgba(255,255,255,0.1)', opacity: opacity, transform: `scale(${stampScale}) rotate(${stampRotate}deg)`, backgroundColor: 'rgba(15, 23, 42, 0.8)', backdropFilter: 'blur(20px)', borderRadius: 24, boxShadow: '0 20px 50px rgba(0,0,0,0.5)' }}>
