...
export const AnimationComponent = () => {
  ...
  return (
    <div style={{ position: 'absolute', top: 0, left: 0, width: 1920, height: 1080, overflow: 'hidden', backgroundColor: 'BACKGROUND_COLOR' }}>
      ...
      {/* MapLibre background */}
      <div ref={mapRef} style={{ position: 'absolute', top: mapY, left: mapX, width: mapW, height: mapH, opacity: mapOp, borderRadius: 4 , filter: 'brightness(2.0) contrast(1.2) saturate(4) hue-rotate(165deg)'}} />
